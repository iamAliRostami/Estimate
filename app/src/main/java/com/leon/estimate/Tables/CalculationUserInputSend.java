...
public class CalculationUserInputSend {
    ...
    public CalculationUserInputSend(String trackingId, String trackNumber, int requestType,
                                    ...
                                    boolean adamTaxfifAb, boolean adamTaxfifFazelab, String address) {
    ...
    public CalculationUserInputSend(String trackingId, String trackNumber, int requestType,
                                    ...
                                    int aianTejari, int sifoon100, int sifoon125, int sifoon150,
                                    int sifoon200, int zarfiatQarardadi, int arzeshMelk,
                                    int tedadMaskooni, int tedadTejari, int tedadSaier,
                                    int tedadTaxfif, String nationalId, boolean ensheabQeireDaem,
                                    boolean adamTaxfifAb, boolean adamTaxfifFazelab, String address) {
        this.trackingId = trackingId;
        this.trackNumber = trackNumber;
